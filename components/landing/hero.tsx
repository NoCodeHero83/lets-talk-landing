    ...
    <section className="relative flex items-start justify-center overflow-hidden pt-20 sm:pt-28 pb-16 sm:pb-24 bg-black">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <span className="absolute rounded-full bg-white animate-star-twinkle" style={{ left: "8%", top: "14%", width: "2px", height: "2px", animationDelay: "0s", animationDuration: "3.8s" }} />
          <span className="absolute rounded-full bg-white animate-star-twinkle" style={{ left: "18%", top: "32%", width: "1.5px", height: "1.5px", animationDelay: "0.7s", animationDuration: "4.2s" }} />
          <span className="absolute rounded-full bg-white animate-star-twinkle" style={{ left: "88%", top: "18%", width: "2px", height: "2px", animationDelay: "1.4s", animationDuration: "3.6s" }} />
          <span className="absolute rounded-full bg-white animate-star-twinkle" style={{ left: "78%", top: "42%", width: "1.5px", height: "1.5px", animationDelay: "2.1s", animationDuration: "4.5s" }} />
          <span className="absolute rounded-full bg-white animate-star-twinkle" style={{ left: "12%", top: "58%", width: "1.5px", height: "1.5px", animationDelay: "0.4s", animationDuration: "3.9s" }} />
          <span className="absolute rounded-full bg-white animate-star-twinkle" style={{ left: "92%", top: "52%", width: "2px", height: "2px", animationDelay: "1.1s", animationDuration: "4.1s" }} />
          <span className="absolute rounded-full bg-white animate-star-twinkle" style={{ left: "6%", top: "78%", width: "1.5px", height: "1.5px", animationDelay: "1.8s", animationDuration: "3.7s" }} />
          <span className="absolute rounded-full bg-white animate-star-twinkle" style={{ left: "94%", top: "78%", width: "1.5px", height: "1.5px", animationDelay: "2.4s", animationDuration: "4.3s" }} />
          <span className="absolute rounded-full bg-white animate-star-twinkle" style={{ left: "28%", top: "8%", width: "1.5px", height: "1.5px", animationDelay: "0.9s", animationDuration: "3.5s" }} />
          <span className="absolute rounded-full bg-white animate-star-twinkle" style={{ left: "68%", top: "12%", width: "2px", height: "2px", animationDelay: "1.6s", animationDuration: "4.0s" }} />
        </div>
